...
public class ShutdownThread extends Thread {
    ...
    /* ------------------------------------------------------------ */
    public static synchronized void register(int index, 
    ...
    public static synchronized void deregister(LifeCycle lifeCycle) {
        ...
        if (_thread._lifeCycles.isEmpty())
            _thread.unhook();
    }
