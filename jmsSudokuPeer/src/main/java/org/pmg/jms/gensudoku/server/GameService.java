...
public interface GameService {
    ...
    public void join(Routable delegate) throws JMSException;
    public void release(String sessionId) throws JMSException;
    public void pushWaitingClient(Routable delegate);
    public void startGame(Routable delegate) throws JMSException;
}
